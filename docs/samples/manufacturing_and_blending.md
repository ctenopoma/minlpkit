...
| blending_mip | 配合設計問題(整数変数付き) (Blending Problem, MIP variant) — 飼料工場の配合(フォーミュレーション)担当者が、トウモロコシ・大豆粕・魚粉などの | — | [source](https://github.com/ctenopoma/minlpkit/blob/main/samples/manufacturing_and_blending/blending_mip.py) |
...
| lot_sizing | 多期間ロットサイジング問題 (Multi-period Lot Sizing Problem) — 消費財メーカーの生産計画担当者が、月次の需要予測をもとに1年間(12か月)の生産 | — | [source](https://github.com/ctenopoma/minlpkit/blob/main/samples/manufacturing_and_blending/lot_sizing.py) |
