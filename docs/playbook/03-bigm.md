...
- 固定費(施設開設・段取り替えなど)を Big-M でモデル化しているが、M をいくつにすべきか
  判断する基準がない。
...
[Big-M排除(tight M・Indicator)](../notebooks/improve/03_bigm_indicator.ipynb) を参照。

### 効かないとき・注意

- **留意点**: 上記の LP 緩和境界の改善とは裏腹に、**既定 SCIP は presolve が緩い
